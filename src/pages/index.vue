  ...
  <div class="container ">
    <div class="top">
      <header class="mask-paper">
        ...
        <div class="input-box">
          <input type="text" class="search-input" placeholder="搜索山小科" />
    ...
    <div class="main">
      <div class="side-bar">
        ...
        <div class="information-container ml">
            <Transition>
          <div class="information-pad  " v-if="isMore">
            <div class="container">
              <div>
                <div>
